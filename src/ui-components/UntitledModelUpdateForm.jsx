...
import { getUntitledModel, listUserProfiles } from "../graphql/queries";
...
export default function UntitledModelUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = untitledModelRecord
      ? { ...initialValues, ...untitledModelRecord, UserProfile }
      : initialValues;
  ...
  React.useEffect(resetStateValues, [untitledModelRecord, UserProfile]);
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            Resume: modelFields.Resume ?? null,
            untitledModelUserProfileId: modelFields?.UserProfile?.id ?? null,
          };
          await API.graphql({
